...
var Composition = Edge.Composition, Symbol = Edge.Symbol; // aliases for commonly used Edge classes
   ...
   (function(symbolName) {
      ...
      Symbol.bindElementAction(compId, symbolName, "${_2}", "click", function(sym, e) {
         ...
         parent.APP.FancyBox.openText ("txt07_02_02");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_3}", "click", function(sym, e) {
         ...
         parent.APP.FancyBox.openText ("txt07_02_03");
      ...
      Symbol.bindElementAction(compId, symbolName, "${_4}", "click", function(sym, e) {
         ...
         parent.APP.FancyBox.openText ("txt07_03_04");
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 4877, function(sym, e) {
         // insert code here
         sym.stop();
      ...
      Symbol.bindTriggerAction(compId, symbolName, "Default Timeline", 7240, function(sym, e) {
         // insert code here
         sym.stop();
...
})(window.jQuery || AdobeEdge.$, AdobeEdge, "EDGE-23181458");